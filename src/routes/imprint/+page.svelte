<svelte:head><title>Juvenile &#8226; Imprint</title></svelte:head>
...
<main class="min-h-screen p-2 max-w-5xl">
	<div class="grid grid-flow-row-dense gap-y-12 leading-loose">
		...
		<div>
			<div>
				<span>Managing Director: </span><span class="text-gray-500">Lord John van Apfel</span>
			</div>
			<div>
				<span>Commercial register: </span><span class="text-gray-500">Amtsgericht Bad Sausage</span>
			</div>
			<div>
				<span>Commercial register number: </span><span class="text-gray-500">HRB 123456</span>
			</div>
			<div>
