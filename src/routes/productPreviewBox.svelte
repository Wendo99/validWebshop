...
<a href="/product/{id}">
	...
	>
		...
		<div class="font-semibold text-center tracking-widest text-gray-700">{title}</div>

		<div class="text-xl tracking-widest text-gray-600">{getCurrencyString(price)}</div>
