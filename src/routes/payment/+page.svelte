						...
						><div class="p-2">
							...
							<div class="grid grid-flow-row gap-y-10">
								...
								<div class="items-center grid row-start-4 gap-x-1 grid-flow-col p-2">
									...
									<span class="items-center text-sm grid col-start-2 justify-items-end"
										>Year<input
											class="items-center rounded-xl h-8 w-20 grid col-start-3"
											id="year"
											type="text"
										/></span
									><span class="items-center text-sm grid col-start-4 justify-items-end"
										>Month<input
											class="items-center rounded-xl h-8 w-20 grid col-start-5"
											id="month"
											type="text"
										/></span
									><span class="items-center text-sm grid col-start-6 justify-items-end"
										>Day<input
											class="items-center rounded-xl h-8 w-20 grid col-start-7"
											id="day"
											type="text"
										/></span
									>
